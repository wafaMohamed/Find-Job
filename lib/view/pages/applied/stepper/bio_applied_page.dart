...
class BioDataAppliedJob extends StatefulWidget {
  const BioDataAppliedJob({Key? key}) : super(key: key);

  @override
  State<BioDataAppliedJob> createState() => _BioDataAppliedJobState();
}

class _BioDataAppliedJobState extends State<BioDataAppliedJob> {

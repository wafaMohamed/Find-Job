import 'package:find_job_amit/view/pages/applied/stepper/portfolio_applied_page.dart';
import 'package:find_job_amit/view/pages/applied/stepper/worke_applied_page.dart';
...
import 'bio_applied_page.dart';


class StepperAppliedJob extends StatefulWidget {
  const StepperAppliedJob({Key? key}) : super(key: key);

  @override
  State<StepperAppliedJob> createState() => _StepperAppliedJobState();
}

class _StepperAppliedJobState extends State<StepperAppliedJob> {
  int currentStep = 0;
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: const AppBarText(text: 'Apply Job'),
              ),
              SizedBox(height: 3.h),
              const Center(child: CustomJobInfo()),
              Row(
                children: [
  ...
  Widget buildStepContent(int step) {
    switch (step) {
      ...
      // put your content screen
        return const BioDataAppliedJob();
      case 1:
        return const TypeOfWorkAppliedJob();
      case 2:
        return const PortfolioAppliedJob();
      default:
        return Container();
    }
  }

...
class PortfolioAppliedJob extends StatefulWidget {
  const PortfolioAppliedJob({Key? key}) : super(key: key);

  @override
  State<PortfolioAppliedJob> createState() => _PortfolioAppliedJobState();
}

class _PortfolioAppliedJobState extends State<PortfolioAppliedJob> {
